class StopSearch 
  ...
  attr_accessor :stop_code, :stop_id, :neighbour_stop_id, :neighbour_stop_code
  ...
  def results
    #@stops ||= Stop.searching(mis_id, stop_id, stop_name, administrative_code, postal_code, stop_code, neighbour_stop_id, 0.0005, has_transition)
